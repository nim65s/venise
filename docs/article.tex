...
\begin{figure}[thpb]
    ...
    \begin{tikzpicture}
        ...
        \draw [->] (a) -- (i) node [left] {$v_1$};
        \draw [->] (b) -- (j) node [left] {$v_2$};
        \draw [->] (c) -- (k) node [below] {$v_3$};
        ...
        \pic [blue, draw, ->, "$\omega$", angle eccentricity=1.1, angle radius=80] {angle = e--o--b};
        \pic [draw, ->, "$\theta_1$", angle radius=20, angle eccentricity=1.3] {angle = f--a--i};
        \pic [draw, ->, "$\theta_2$", angle radius=10, angle eccentricity=1.5] {angle = g--b--j};
        \pic [draw, ->, "$\theta_3$", angle radius=5, angle eccentricity=2] {angle = h--c--k};
    \end{tikzpicture}
