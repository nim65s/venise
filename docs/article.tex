...
\begin{figure}[thpb]
    ...
    \begin{tikzpicture}
        ...
        \coordinate (d) at ($ (O.side 7) + (0, 0.5) $);
        ...
        \draw [->, red] (o) -- (v) node [left] {$v$};
        \draw [->, red] (a) -- ++(v) node [left] {$v$};
        \draw [->, red] (b) -- ++(v) node [right] {$v$};
        \draw [->, red] (c) -- ++(v) node [left] {$v$};
        \draw [->, blue] (a) -- ++(x) node [right] {$\omega R_1$};
        \draw [->, blue] (b) -- ++(y) node [left] {$\omega R_2$};
        \draw [->, blue] (c) -- ++(z) node [left] {$\omega R_3$};
        \draw [->] (a) -- ($ (a) + (v) + (x) $) node [left] {$v_1$};
        \draw [->] (b) -- ($ (b) + (v) + (y) $) node [left] {$v_2$};
        \draw [->] (c) -- ($ (c) + (v) + (z) $) node [below] {$v_3$};
        \draw [blue, dashed] ($ (a) + (v) $) -- ($ (a) + (v) + (x) $);
        \draw [blue, dashed] ($ (b) + (v) $) -- ($ (b) + (v) + (y) $);
        \draw [blue, dashed] ($ (c) + (v) $) -- ($ (c) + (v) + (z) $);
        \draw [red, dashed] ($ (a) + (x) $) -- ($ (a) + (v) + (x) $);
        \draw [red, dashed] ($ (b) + (y) $) -- ($ (b) + (v) + (y) $);
        \draw [red, dashed] ($ (c) + (z) $) -- ($ (c) + (v) + (z) $);
        \draw [blue] (o) -- (a) node [pos=0.5, above] {$R_1$};
        \draw [blue] (o) -- (b) node [pos=0.7, below] {$R_2$};
        \draw [blue] (o) -- (c) node [pos=0.5, above] {$R_3$};
        \pic [black!60!green, draw, ->, "$\theta$", angle eccentricity=1.5] {angle = d--o--v};
        \pic [blue, draw, ->, "$\omega$", angle eccentricity=1.1, angle radius=75] {angle = d--o--b};
    \end{tikzpicture}
