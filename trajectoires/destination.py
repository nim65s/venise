...
trajectoire_destination_parser.add_argument('--v1', type=float, default=2)
trajectoire_destination_parser.add_argument('--v2', type=float, default=2)
trajectoire_destination_parser.add_argument('--v3', type=float, default=2)
